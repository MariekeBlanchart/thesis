...
simple example, here is a complete program to py a circle of radius
...
class GraphicsObject:
    ...
    def draw(self, graphwin):
        ...
        window. Raises an error if attempt made to py an object that
        is already visible."""

        if self.canvas and not self.canvas.isClosed(): raise GraphicsError(OBJ_ALREADY_DRAWN)
        if graphwin.isClosed(): raise GraphicsError("Can't py to closed window")
